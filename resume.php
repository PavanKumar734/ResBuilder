...
<link href="https://fonts.googleapis.com/css2?family=Caveat:wght@400..700&family=Dancing+Script:wght@400..700&family=Exo:ital,wght@0,100..900;1,100..900&family=Fuggles&family=Gloria+Hallelujah&family=Mooli&family=Nunito:ital,wght@0,200..1000;1,200..1000&family=Zilla+Slab:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet">
    ...
    <style>
        body {
            ...
            background: radial-gradient(circle, rgba(249, 249, 249, 1) 0%, rgba(240, 232, 127, 1) 49%, rgba(246, 243, 132, 1) 100%);
             background-image: url(./Asset/images/tiles/<?=$resume['background']?>);
...
<a href="whatsapp://send?text=<?=$actual_link?>" class="btn btn-light btn-sm"><i class="bi bi-share-fill"></i> Share</a>
...
<div class="tile rounded shadow-sm border" data-background="tile<?=$i?>.png" style="background-image:url(./Asset/images/tiles/tile<?=$i?>.png)"></div>
<?php
}
?>
<div class="tile rounded shadow-sm border" data-background="tile23.jpg" style="background-image:url(./Asset/images/tiles/tile23.jpg)"></div>
...
<option value="'Dancing Script'" style="font-family:'Dancing Script', cursive" <?=$resume['font']=="'Dancing Script', cursive"?'selected':''?>>'Dancing Script', cursive</option>
...
<option value="'Gloria Hallelujah'" style="font-family:'Gloria Hallelujah', cursive" <?=$resume['font']=="'Gloria Hallelujah', cursive"?'selected':''?>>'Gloria Hallelujah', cursive</option>
...
$("#downloadpdf").click(function(){
    window.jsPDF = window.jspdf.jsPDF; //details is jspdf website
    var doc = new jsPDF();
...
$("body").css('background-image','url(./Asset/images/tiles/'+tile+')');
