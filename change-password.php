...
$fn->nonAuthPage(); //only gives access if we logged in.
?>
        ...
        <main class="form-signin w-100 m-auto bg-white shadow rounded">
            <form action="actions/changepassword.action.php" method="post">
                ...
                <div class="form-floating mb-4">
                    <input type="text" name="password" class="form-control" id="floatingEmail" placeholder="name@example.com" required>
