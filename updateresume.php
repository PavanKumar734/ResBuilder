...
<div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                   If u have experience you can add it
                                </p>
...
<div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                   If u have education you can add it
                                </p>
...
?>
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" id="inputPassword4" name="institute" placeholder=" Central Board Of Secondary Education, New Delhi " required>
  </div>
